...
class EspnFantasyBasketballRequestWithPost(EspnFantasyRequests):
    ...
    @staticmethod
    def from_espn_fantasy_request(request: EspnFantasyRequests) -> 'EspnFantasyBasketballRequestWithPost':
        return EspnFantasyBasketballRequestWithPost("nba", request.year, request.league_id, request.cookies, request.logger)
